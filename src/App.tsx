...
export const App = () => {
  ...
  const submit = () => {
    window.gtag("event", "6176_get_sub", {
      variant_name: "6176_2",
    });
      ...
      <div className={appSt.container}>
        <div className={appSt.box}>
          ...
          <Typography.Text view="primary-medium">
            Первый месяц бесплатно, <br /> а далее 499 ₽ в месяц
          </Typography.Text>
        </div>
        ...
        >
          <img src={fire} alt="" width={24} height={24} />
          <Typography.Text view="primary-small">
            Делитесь привилегиями c 2 близкими бесплатно
          </Typography.Text>
        </div>
